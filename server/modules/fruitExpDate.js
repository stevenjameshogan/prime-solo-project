...
// This module is a function that returns an expiration date for each food in the "Fruits" category depending on physical location

function fruitExpDate(food) {
    let date = moment();
