...
class FridgeItem extends Component {
    constructor(props) {
        ...
        this.state = ({
            ...
            editMode: false,
            // Create object for potential user changes to this FridgeItem. Set default values as original values passed as props.
            foodItem: {
    ...
    // Capture user inputs so if this Fridge item is edited we can store the new inputs in our local state
    ...
    // Dispatch updated Fridge Item to a Redux Saga in order to update database and DOM display
    updateItem = (event) => {
            ...
            return (
                <div className="kitchenItem">
                    ...
                    <Dialog open={this.state.open} onClose={this.handleClose} className="foodItemDialog" >
                        ...
                        <DialogContent className="foodItemDialog">
